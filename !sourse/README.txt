...
- ### [___] / [___] (https://www..com/)
    -  ### [___] / [Основы](https://www..com/)
        - [Getting : Python] / [Основы : Переменные]()
        - [Getting : Python] / [Основы : Типы]()
        - [Getting : Python] / [Основы : Циклы]()
        - [Getting : Python] / [Основы : Типы]()
        - [Getting : Python] / [Основы : Списки (массивы)]()
        - [Getting : Python] / [Основы : Индексы и срезы]()
        - [Getting : Python] / [Основы : Кортежи]()
        - [Getting : Python] / [Основы : Словари]()
        - [Getting : Python] / [Основы : Множества]()
...
This is a repository of all the tutorials of [The Python Code] / Это репозиторий всех учебных пособий веб-сайта [Код Python] (https://www.thepythoncode.com) website.
## List of Tutorials / Список учебных пособий
...
- ### [Handling PDF Files] / [Обработка PDF-файлов] (https://www.thepythoncode.com/topic/handling-pdf-files)
    ...
    - [How to Sign PDF Files] / Пподписание PDF-файлов] (https://www.thepythoncode.com/article/sign-pdf-files-in-python). ([code](handling-pdf-files/pdf-signer))
