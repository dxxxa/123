...
path = "C:\\Users\\user\\PycharmProjects\\pythonProject2"  # Каталог текстовых файлов
path_data = "C:\\Users\\user\\PycharmProjects\\pythonProject2\\data.txt"  # Путь к файлу сортировки data.txt
path_sort = "C:\\Users\\user\\PycharmProjects\\pythonProject2\\Sort"  # Каталог сортировки с файлами 0-9.txt & A-Z.txt
...
if os.path.exists(path_data):  # os.path.exists(path_data) Проверяет существует ли файл "C:\\Users\\path_data\\text.txt"
    ...
    try:
        with open(input_file_name) as fr:
            ...
            for s in tqdm(fr.readlines()):
                try:
                    ...
                    my_file.close()
                fw.append(s)
            print("Error: Строка с символом!!!", i)
        ...
        print("[Error!]Удаление каталога Sort и файлов.txt")
